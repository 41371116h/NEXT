...
function init(){
	...
	pp = new TEACHER.ObjTextPlane(120,20,"156828黃惠榆",'z',0xffff00,);
	...
	ball = new TEACHER.ObjSphere(2,0xFF9900);
	scene.add(ball);
...
function tick(){
	...
	ball.visible = world2D.ch01.checked;
